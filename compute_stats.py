...
def run_nuclei_type_stat(pred_dir, true_dir, dataset_name, type_uid_list=None, exhaustive=True):
    ...
    for file_idx, filename in enumerate(file_list[:]):
        ...
        if dataset_name == "GLySAC":
            ...
            true_inst_type[(true_inst_type == 3) | (true_inst_type == 8)] = 3
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pred_dir", help="point to output dir", nargs="?", default=f"./test_output/mat/", const=""
    )
    parser.add_argument(
        "--true_dir", help="point to ground truth dir", nargs="?", default=f"./dataset/Test/Labels/", const=""
    )
